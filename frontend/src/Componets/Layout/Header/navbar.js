...
function Navbar() {
    ...
    // Render
    return <NavbarContDiv>
        <NavbarLogoContDiv>
            <img alt="Luna Logo" src={require("../../../Assets/logo.svg").default}/>
        </NavbarLogoContDiv>
        <NavbarButtonsContDiv>
            <NavbarLogoPageTabsDiv onClick={()=>navigate("/createRestaurant")} className={activePage==="createRestaurant"?"active":"not-active"}>
                <span>Create Restaurant</span>
            </NavbarLogoPageTabsDiv>
            <NavbarLogoPageTabsDiv onClick={handleNavHome} className={activePage==="/"?"active":"not-active"}>
                <span>Home</span>
            </NavbarLogoPageTabsDiv>
            <NavbarLogoPageTabsDiv onClick={handleNavSearch} className={activePage==="Search"?"active":"not-active"}>
                <span>Search</span>
            </NavbarLogoPageTabsDiv>
            <NavbarLogoPageTabsDiv onClick={handleNavProfile} className={activePage==="Profile"?"active":"not-active"}>
                <span>Profile</span>
            </NavbarLogoPageTabsDiv>
            <NavbarSignUpButtonGroupsDiv>
